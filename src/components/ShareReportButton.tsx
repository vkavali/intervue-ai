  ...
  if (!shareToken) {
    return (
      <button
        ...
        disabled={loading}
        className="inline-flex items-center gap-2 rounded-lg bg-saffron px-5 py-2.5 text-sm font-medium text-white hover:bg-saffron transition-colors disabled:opacity-50"
      >
