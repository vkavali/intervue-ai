...
function getProficiencyLevel(avgScore: number): { label: string; color: string; gradient: string } {
  ...
  if (avgScore >= 70) return { label: "Advanced", color: "text-india-green", gradient: "from-blue-500 to-cyan-500" }
  if (avgScore >= 50) return { label: "Intermediate", color: "text-yellow-400", gradient: "from-yellow-500 to-amber-500" }
  return { label: "Beginner", color: "text-gray-500", gradient: "from-gray-500 to-gray-600" }
}
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-16 space-y-10">
        ...
        <div className="text-center space-y-5">
          <div className="relative inline-block">
            ...
            <div className={`relative h-20 w-20 rounded-full bg-gradient-to-br ${proficiency.gradient} flex items-center justify-center text-3xl font-bold text-gray-900 shadow-2xl mx-auto`}>
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <span className={`inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r ${proficiency.gradient} px-4 py-1.5 text-sm font-semibold text-gray-900 shadow-lg`}>
              {proficiency.label}
            </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="group rounded-2xl border border-blue-500/20 bg-gradient-to-b from-blue-500/10 to-gray-900/80 p-6 text-center shadow-sm transition-all hover:scale-[1.03] hover:-translate-y-1 hover:shadow-blue-900/20">
            ...
            <p className="text-3xl font-bold text-india-green">{sessions.length}</p>
            <p className="mt-1 text-xs text-gray-500 uppercase tracking-wider">Verified Interviews</p>
          </div>
          <div className="group rounded-2xl border border-saffron/20 bg-gradient-to-b from-saffron/10 to-gray-900/80 p-6 text-center shadow-sm transition-all hover:scale-[1.03] hover:-translate-y-1 hover:shadow-saffron-dark/20">
          ...
          <div className="group rounded-2xl border border-green-500/20 bg-gradient-to-b from-green-500/10 to-gray-900/80 p-6 text-center shadow-sm transition-all hover:scale-[1.03] hover:-translate-y-1 hover:shadow-green-900/20">
        ...
        {sessions.length > 0 ? (
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-bold text-gray-900">Interview Badges</h2>
            </div>
              ...
              {sessions.map((s) => {
                ...
                return (
                  <Link
                    ...
                    className={`group rounded-2xl border ${scoreColor} bg-gradient-to-b ${scoreGradient} to-gray-900/80 p-6 transition-all duration-300 hover:scale-[1.03] hover:-translate-y-1 shadow-sm`}
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <p className="text-base font-semibold text-gray-900 group-hover:bg-gradient-to-r group-hover:from-saffron group-hover:to-india-green group-hover:bg-clip-text group-hover:text-transparent transition-all">
                          {s.template.role}
                        </p>
          ...
          <div className="rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-900/80 to-gray-950 p-12 text-center shadow-sm">
            ...
            <p className="text-gray-500">No shared interview badges yet.</p>
          </div>
        )}
        ...
        <div className="relative rounded-2xl border border-saffron/20 bg-gradient-to-r from-saffron-dark/30 via-gray-900/80 to-india-green-dark/30 p-10 text-center shadow-2xl shadow-saffron-dark/10 overflow-hidden">
          ...
          <div className="relative">
            <p className="text-2xl font-bold text-gray-900">Build Your Own Talent Profile</p>
