...
const statusConfig: Record<string, { label: string; color: string; bg: string }> = {
  ...
  ACTIVE: { label: 'Active', color: 'bg-blue-500', bg: 'bg-blue-500/10 text-blue-400' },
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-white">No Company Associated</h2>
    ...
    <div className="min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-white">{completionRate.toFixed(1)}%</p>
            </div>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-white">{averageScore.toFixed(1)}</p>
            </div>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-400">Hire Rate</p>
              <p className="mt-2 text-3xl font-bold text-white">{hireRate.toFixed(1)}%</p>
            </div>
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-cyan-600 text-white">
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-4">
            {scoreRanges.map((range) => (
              <div key={range.label} className="flex items-center gap-4">
                <span className="w-14 text-sm text-gray-400 text-right shrink-0">
                  {range.label}
                </span>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          <h3 className="text-lg font-semibold text-white mb-6">Interviews by Status</h3>
            ...
            {Object.entries(statusCounts).map(([status, count]) => {
              ...
              return (
                <div key={status} className="flex-1 flex flex-col items-center gap-2">
                  ...
                  <div className="w-full bg-gray-800 rounded-t-lg relative" style={{ height: '140px' }}>
                    <div
        ...
        {/* AI Level Usage */}
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          <h3 className="text-lg font-semibold text-white mb-6">AI Level Usage</h3>
          <div className="space-y-4">
            {[0, 1, 2, 3, 4].map((level) => {
              ...
              return (
                <div key={level} className="flex items-center gap-3">
                  <span className="w-32 text-sm text-gray-400 shrink-0">
                    {aiLevelLabels[level]}
                  </span>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          <h3 className="text-lg font-semibold text-white mb-6">Top Performing Questions</h3>
              ...
              {topTemplates.map((t, i) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="text-lg font-bold text-white">{t.avgScore.toFixed(1)}</p>
      ...
      <div className="rounded-xl border border-gray-800 bg-gray-900 mb-8 overflow-hidden">
        <div className="border-b border-gray-800 px-6 py-4">
          <h3 className="text-lg font-semibold text-white">Interviewer Leaderboard</h3>
        </div>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-800">
                {interviewerLeaderboard.map((interviewer, i) => (
                  <tr key={interviewer.id} className="hover:bg-gray-800/50 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          <h3 className="text-lg font-semibold text-white mb-6">Monthly Interview Trends</h3>
            ...
            {monthlyData.map((m) => {
              ...
              return (
                <div key={m.label} className="flex-1 flex flex-col items-center gap-1">
                  <span className="text-xs font-semibold text-white">{m.count}</span>
                  <div
          ...
          <div className="border-t border-gray-800 pt-4">
            <table className="w-full text-sm">
              ...
              <tbody>
                {monthlyData.map((m) => (
                  <tr key={m.label} className="border-t border-gray-800/50">
                    <td className="py-1.5 text-gray-300">{m.label}</td>
                    <td className="py-1.5 text-center text-gray-300">{m.count}</td>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
          ...
          <div className="rounded-lg border border-gray-800 bg-gray-800/30 p-5 mb-5">
            <h4 className="text-sm font-medium text-gray-300 mb-3">AI Assist Effectiveness</h4>
          ...
          <div className="rounded-lg border border-gray-800 bg-gray-800/30 p-5">
            <h4 className="text-sm font-medium text-gray-300 mb-4">AI Interaction Summary</h4>
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <p className="text-3xl font-bold text-white">{totalAiInteractions.toLocaleString()}</p>
                <p className="text-xs text-gray-500 mt-1">Total AI Interactions</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-white">{avgAiPerSession.toFixed(1)}</p>
