      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        {isAdmin ? (
          <>
            ...
            >
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-blue-500/10 text-blue-400 group-hover:bg-india-green/10/20">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <>
            ...
            <Link
              ...
              className="flex items-center gap-4 rounded-xl border border-gray-800 bg-gray-900 p-6 transition-all hover:border-cyan-500/50 hover:bg-gray-900/80 group"
            >
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-cyan-500/10 text-cyan-400 group-hover:bg-cyan-500/20">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                </svg>
              </div>
              <div>
                <h3 className="text-sm font-semibold text-white">My Calendar</h3>
                <p className="text-xs text-gray-400">
