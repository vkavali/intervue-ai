...
export default async function CandidateReportPage({
  ...
  if (!report) {
    return (
      <div className="max-w-3xl mx-auto">
        <div className="rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-900/80 to-gray-950 p-12 text-center shadow-2xl">
          ...
          <h3 className="text-xl font-bold text-gray-900">Report Not Ready</h3>
          ...
          <Link
            href="/candidate"
            className="mt-8 inline-flex items-center gap-2 rounded-xl border border-saffron bg-transparent px-6 py-3 text-sm font-semibold text-saffron-dark shadow-lg shadow-saffron/20 transition-all hover:shadow-saffron/40 hover:scale-[1.02]"
          >
            Back to Dashboard
          </Link>
        </div>
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 relative">
      ...
      <Link
        href="/candidate"
        className="relative inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-saffron transition-colors group"
      >
      ...
      <div className="relative rounded-2xl border border-saffron/20 bg-gradient-to-br from-saffron-dark/20 via-gray-900/80 to-india-green-dark/20 p-8 shadow-2xl shadow-saffron-dark/10 overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2 text-sm text-gray-500">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-xs">
              {interviewSession.company.name}
            </span>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-india-green/20 bg-india-green/10 px-3 py-1 text-xs text-india-green">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-cyan-500/20 bg-india-green/10 px-3 py-1 text-xs text-india-green">
      ...
      {/* 2. Score Overview */}
      <div className="relative rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-900/90 to-gray-950 p-8 shadow-2xl overflow-hidden">
      ...
      {/* 3. Metric Bars */}
      <div className="rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-900/80 to-gray-950 p-8 shadow-sm">
      ...
      {(improvements.length > 0 || riskFlags.length > 0) && (
        <div className="rounded-2xl border border-amber-500/20 bg-gradient-to-br from-amber-900/10 via-gray-900/80 to-gray-950 p-8 shadow-sm shadow-amber-900/5">
          <div className="flex items-center gap-3 mb-6">
      ...
      {quoteHighlights.length > 0 && (
        <div className="rounded-2xl border border-india-green/20 bg-gradient-to-br from-blue-900/10 via-gray-900/80 to-gray-950 p-8 shadow-sm shadow-blue-900/5">
          <div className="flex items-center gap-3 mb-6">
      ...
      {report.thinkingTrace && (
        <div className="rounded-2xl border border-saffron/20 bg-gradient-to-br from-saffron-dark/10 via-gray-900/80 to-gray-950 p-8 shadow-sm shadow-saffron-dark/5">
          <div className="flex items-center gap-3 mb-6">
      ...
      <div className="rounded-2xl border border-saffron/20 bg-gradient-to-r from-saffron-dark/20 via-gray-900/80 to-india-green-dark/20 p-8 shadow-2xl shadow-saffron-dark/10 overflow-hidden relative">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-lg font-bold text-gray-900">Share Your Results</h2>
          </div>
